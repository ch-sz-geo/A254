...
* *__Grundwasseraustritte und -fassungen__.*

Dieses Thema ist beim Bund über den Geobasisdatensatz "Grundwasseraustritte, -fassungen und -anreicherungsnalgen" (ID 141) modelliert. Der kantonale Geobasisdatensatz erweitert den Bundesdatensatz mit Mehranforderungen.
