...
Das Thema A059 führt die meisten Klassen, welche als Datenquelle für die Grundwasseraustritte, -fassungen und -anreicherungsanlagen dient. Das Thema A034 ist lediglich die Datenquelle für die "Rückgabebrunnen" (siehe Abbildung unten).
